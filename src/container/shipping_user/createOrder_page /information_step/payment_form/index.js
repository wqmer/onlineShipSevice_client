...
const payment_method = [
  ...
  },
  {
    ...
    key: "paypal",
    Icon: undefined,
    content: "paypal information form",
  },
    ...
    return (
      <div>
        <Collapse
          ...
          onChange={(e) => {
            if (
              this.props.payment_information.payment_method == e ||
              e == undefined
            )
              return;
              ...
              header={
                <div>
                  <Radio
                    ...
                    // }}
                    checked={
                      this.props.payment_information.payment_method == item.key
                    }
                    value={item.key}
                  ></Radio>
                  <Title
                    ...
                    level={4}
                    type={
                      this.state.disabled_method.includes(item.key)
                        ? "secondary"
                        : "strong"
                    }
                  >
...
export default connect(mapStateToProps, mapDispatchToProps)(Payment_form);
